<div id="subcontent">
    ...
    <div class="page_content">
        ...
        <div style="display: table-cell; padding: 30px; vertical-align: top; position: relative;">
            ...
            <div class="hide" id="hide1" style="position: absolute; bottom: 35px; right: 20px;">
                Conceptos de interés
            </div>            
            <div style="cursor:pointer; position: absolute; bottom: 15px; right: 20px;">
                <img onclick="loadXMLIndex2()" onmouseover="showItem('#hide1')" onmouseout="hideItem('#hide1')" src="/images/next_button.png"/>
            </div>
        </div>
    </div>
</div>